...
- `sentences/`: directory containing Lexa sentence collections (`lexacl`).
...
To quick-start a new database, just run:

``` r
library(lexa)
create_lexadb(name = "my")
```
...
Texts are located in the `sentences/` folder.
